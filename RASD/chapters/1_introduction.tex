...
\begin{enumerate}[label=\textbf{G.\arabic*}]
    ...
    \item \itemtext{goal:targetDevices}{Allow the application to target most of available devices.}

	\item \itemtext{goal:enjoyService}{Allow customers, even the ones who don't have access to technology, to enjoy the service.}

	\item \itemtext{goal:monitorAccess}{Allow supermarkets to manage and to monitor access to stores in a better way.}
	\begin{enumerate}[label*=\textbf{.\arabic*}, leftmargin=+.5in]
