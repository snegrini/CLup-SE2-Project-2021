...
\begin{itemize}
	...
	\item \textbf{Store employee}: They are the employee of the store. They validate the tickets at the entrance of the store. They could not have experience
...
\begin{enumerate}[label=\textbf{D.\arabic*}]
	\item \itemtext{dom:smartphone}{The majority of the customers has a smartphone.}
	...
	\item \itemtext{dom:uniqueName}{Stores are easily searchable and have unique names.}
    ...
    % TODO compare with FUN.REQ.
	\item \itemtext{dom:capStores}{Store managers define the cap of customers both in stores and queues.}
