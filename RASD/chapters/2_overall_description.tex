...
\textit{Customers Line-up} platform grants supermarkets a way to manage queues and customers inside their stores. In particular, \textbf{upon authentication}, it offers two level of access: \textit{manager level} and \textit{entrance-staff level}.
