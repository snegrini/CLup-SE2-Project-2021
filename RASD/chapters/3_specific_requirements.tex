...
In this section, it is given a complete description of the functional requirements of the system.
    ...
    \begin{enumerate}[resume*=requirements]
        \item \itemtext{req:stfLogin}{A registered store employee must be able to login to the system by using their credentials.}
    ...
    \begin{table}[H]
	    ...
	    \begin{tabular}{@{}p{0.08\linewidth}cccccccccccccccccccccc@{}}  
	         ...
	         \bottomrule
	     \end{tabular}}
     	\caption{\textit{Traceability matrix} for requirements R.1 to R.13.}
 	 \end{table}
	 ...
	 \begin{table}[H]
	     ...
	     \begin{tabular}{@{}p{0.08\linewidth}cccccc|ccccc|cc@{}} 
	         ...
	         \bottomrule
	     \end{tabular}}
     	 \caption{\textit{Traceability matrix} for requirements R.14 to R.24.}
    \end{table}
