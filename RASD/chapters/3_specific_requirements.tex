...
In this section, it is given a complete description of the functional requirements of the system.
    ...
    \begin{center}
        \begin{tabular}{@{}p{0.08\linewidth}cccccccccccccccccccccc@{}}
            ...
            \textbf{UC.\ref{uc:retrieveTicket}} & \cmark & \cmark & & \cmark & \cmark & \cmark & & \cmark & \cmark \\
            \textbf{UC.\ref{uc:bookVisit}} & \cmark & & & & & \cmark & & \cmark & \cmark & \cmark & \cmark \\
            \textbf{UC.\ref{uc:deletePass}} & & & & & & & \cmark & \cmark & & & & \cmark & \cmark \\
            \textbf{UC.\ref{uc:webLogin}} & \\
            \textbf{UC.\ref{uc:registerStore}} & \\
            \textbf{UC.\ref{uc:monitorBookings}} & \\
            \midrule
            \ref{goal:custHazardSit} & \cmark & & & \cmark & \cmark & & & & \cmark & \cmark & \cmark \\
            \ref{goal:storeHazardSit} & \\
            ...
            \ref{goal:monitorAccess} & \\
            \ref{goal:knowInAdvance} & \\
            \ref{goal:limitNumber} & \\
